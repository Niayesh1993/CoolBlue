 ...
 */
public class CoolBlueViewModelFactory implements ViewModelProvider.Factory {
    private Map<Class<? extends ViewModel>, Provider<ViewModel>> creators;

    @Inject
    public CoolBlueViewModelFactory(Map<Class<? extends ViewModel>, Provider<ViewModel>> creators) {
